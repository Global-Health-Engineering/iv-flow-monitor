...
#define FLOW_AVG_WINDOW          5      // keep last 30 drops for moving-avg
...
static void MX_GPIO_Init(void)
{
  ...
  /*Configure GPIO pins : BTN_MUTE_Pin BTN_MODE_Pin BTN_PLUS_Pin BTN_MINUS_Pin */
  GPIO_InitStruct.Pin = BTN_MUTE_Pin|BTN_MODE_Pin|BTN_PLUS_Pin|BTN_MINUS_Pin;
