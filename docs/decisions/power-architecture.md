...
The Rev-A device was powered by a Li-ion AA cell (Paleblue) boosted to 3.3 V by the TPS610981. The decision was reopened, an unbiased comparison was produced, and external clinical input was sought from Dr. Janis Tupesis (WHO EMT, deployment experience in Liberia, Haiti, Gaza) on field power realities.
...
- **Integrated PCB-mounted solar harvesting (BQ25504 / AEM10941).** Investigated in depth (see process doc §5). Rejected for Rev-B on the grounds of **thermal safety** — a device in direct equatorial sun reaches 60–80 °C interior, above the 45 °C Li-ion charging ceiling, triggering IEC 60601-1 "reasonably foreseeable misuse" testing burden.
